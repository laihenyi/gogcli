---
name: gog-gmail
description: "Gmail reads and approved writes through the gog CLI. Use when a task needs Gmail data or changes from a shell or script: explicit account selection, stable JSON output, read-only and dry-run guards."
---
