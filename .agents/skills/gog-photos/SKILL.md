---
name: gog-photos
description: "Google Photos reads and approved writes through the gog CLI. Use when a task needs Google Photos data or changes from a shell or script: explicit account selection, stable JSON output, read-only and dry-run guards."
---
